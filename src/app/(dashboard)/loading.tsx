...
export default function Loading() {
  return (
    <div className="flex h-[calc(100vh-8rem)] w-full items-center justify-center rounded-lg border-2 border-dashed bg-card/50 p-8">
      <div className="flex flex-col items-center gap-4 text-center">
        <LayoutDashboard className="h-12 w-12 text-primary animate-pulse" />
        <h2 className="text-2xl font-bold font-headline">Loading Page...</h2>
